function [L_command,sig,quaty] = attitude_controller_rntref(z,IC)
...
obelvec = coord_set_convert('cart', [radial',velly'], 0, IC.mu_e);
...
w_rn_R = IC.N_C_R'*orbw;
w_ref_dot = IC.N_C_R'*orbwd;
